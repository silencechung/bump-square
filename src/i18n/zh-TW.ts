...
export const strings = {
  ...
  'header.ai.structure.label': '產生結構',
  'header.ai.structure.running': '產生中…',
  'header.ai.structure.why': '依 Frame + comment 產生意圖結構樹',
  'header.ai.structure.gate': '先在 Layout 畫至少一個 Frame',
  'header.ai.assets.label': 'Assets',
  'header.ai.assets.running': '生成中…',
  'header.ai.assets.why': '由 agent 依結構推敲視覺素材',
  'header.ai.assets.gate': '先產生結構',
  ...
  'structure.stale.prompt': '結構 / Prompt 已過期 — 按 header 的「🧩 產生結構」重新產生。',
  'structure.stale.assets': 'Assets prompt 已過期 — 按「✨ 生成 assets prompt」重新產生。',
  ...
  'agent.emptyTop': '每次按 header 上的 AI 按鈕(🧩 產生結構 / ✨ assets prompt),這裡會記一筆。',
