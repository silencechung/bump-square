...
export const strings: Record<keyof typeof ZhTW, string> = {
  ...
  'header.ai.structure.label': 'Structure',
  'header.ai.structure.running': 'Generating…',
  'header.ai.structure.why': 'Build the intent tree from Frame + comment',
  'header.ai.structure.gate': 'Draw at least one Frame in Layout first',
  'header.ai.assets.label': 'Assets',
  'header.ai.assets.running': 'Generating…',
  'header.ai.assets.why': 'Let the agent suggest visual assets from the structure',
  'header.ai.assets.gate': 'Generate the structure first',
  ...
  'structure.stale.prompt': 'Structure / Prompt is stale — press header「🧩 Structure」to regenerate.',
  'structure.stale.assets': 'Assets prompt is stale — press「✨ Assets」to regenerate.',
  ...
  'agent.emptyTop': 'Each press of an AI button in the header (🧩 Structure / ✨ Assets) records a row here.',
